ss.aipe.R2 <-
function(Population.R2=NULL, conf.level=.95, width=NULL, Random.Predictors=TRUE, which.width="Full", p=NULL, degree.of.certainty=NULL, Tol=1e-9, ...)
{
...
tmp.MBESS <- ci.R2(R2=Expected.R2(Population.R2=Population.R2, N=N.1, p=p), alpha.lower=alpha.lower, alpha.upper=alpha.upper, N=N.1, p=p, Random.Predictors=Random.Predictors)

if(is.null(degree.of.certainty)) 
{
Result.Full <- list(Required.Sample.Size=N.1, Expected.Width=tmp.MBESS$Upper.Conf.Limit.R2 - tmp.MBESS$Lower.Conf.Limit.R2)
return(Result.Full)
}
...
CI.2.M <- ci.R2(R2=Expected.R2(Population.R2=Population.R2, N=N.2, p=p), alpha.lower=alpha.lower, alpha.upper=alpha.upper, N=N.2, p=p, Random.Predictors=Random.Predictors)
...
CI.3.M <- ci.R2(R2=Expected.R2(Population.R2=Population.R2, N=N.3, p=p), alpha.lower=alpha.lower, alpha.upper=alpha.upper, N=N.3, p=p, Random.Predictors=Random.Predictors)
...
Optimize.Result <- optimize(f=CI.WIDTH.R2, interval = c(0, 1), maximum = TRUE, tol = .Machine$double.eps^0.25, N=Result.Full$Required.Sample.Size, p=p, conf.level=conf.level, Random.Predictors=Random.Predictors)$maximum
...
CI.4 <- ci.R2(R2=Expected.R2(Population.R2=Optimize.Result, N=N.4, p=p), alpha.lower=alpha.lower, alpha.upper=alpha.upper, N=N.4, p=p, Random.Predictors=Random.Predictors)
...
CI.4.M <- ci.R2(R2=Expected.R2(Population.R2=Optimize.Result, N=N.4, p=p), alpha.lower=alpha.lower, alpha.upper=alpha.upper, N=N.4, p=p, Random.Predictors=Random.Predictors)
